-- ============================================================================
-- FIX: Recreate get_dashboard_data function with encrypted fields
-- This migration drops and recreates the function to support encrypted columns
-- ============================================================================

-- Drop existing function to allow recreation with same signature
DROP FUNCTION IF EXISTS get_dashboard_data(UUID, TEXT);
DROP FUNCTION IF EXISTS get_dashboard_data(UUID);

-- Recreate the function with encrypted field support
