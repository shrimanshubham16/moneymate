-- P0 HOTFIX: Fix get_dashboard_data function - card_limit column doesn't exist
-- The previous migration referenced cc.card_limit which doesn't exist in the schema
