...
- r/India post
- r/startups post (if applicable)

### Evening (6 PM)
**Instagram:**
- Launch post with screenshot
- Story with link
...
### Monday
- Feature highlight: Health Score
- Share use case
...
2. **User Tips**
   - How to use FinFlow effectively
   - Best practices
...
**Secondary:**
#FinancialHealth #Budgeting #MoneyManagement #FinTech #FreeTool

**Use 2-3 per post, not all**
...
- **Instagram:** 1 post per day, 1-2 stories
- **Facebook:** 2-3 posts per week
- **Reddit:** 1-2 posts per week (different subreddits)
...
2. **Be Authentic** - Don't sound like a bot
3. **Ask Questions** - Encourage engagement
4. **Share Value** - Tips, insights, not just promotion
